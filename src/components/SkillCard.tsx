...
function SkillCard({ icon, skillName, description, progress }: SkillCardProps) {
    return (
        <div className="bg-white rounded-2xl border border-[#fce8d4] p-4">
            <div className="flex gap-3">
                <div className="w-10 h-10 flex items-center justify-center bg-gradient-to-b from-[#fdeddd] to-[#fff] rounded-[7px]">
                    {icon}
                </div>
